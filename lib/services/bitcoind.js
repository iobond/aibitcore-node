...
var BitcoinRPC = require('aibd-rpc');
...
Bitcoin.prototype.getAPIMethods = function() {
  var methods = [
    ...
    ['verifyTokenOrigin', this, this.verifyTokenOrigin, 1],
...
Bitcoin.prototype.verifyTokenOrigin = function(opts, callback) {
    var self = this;
    this.client.verifytokenorigin(opts, function(err, response) {
        if (err) {
            return callback(self._wrapRPCError(err));
        }
        callback(null, response.result == 'true');
    });
};
